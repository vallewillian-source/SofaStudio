            ...
            Controls.TabBar {
                ...
                Repeater {
                    ...
                    contentItem: RowLayout {
                        ...
                        Item {
                            Layout.preferredWidth: model.type === "indexes" ? 14 : 0
                            Layout.preferredHeight: model.type === "indexes" ? 14 : 0
                            visible: model.type === "indexes"

                            Image {
                                id: indexesTabIcon
                                anchors.fill: parent
                                source: model.type === "indexes" ? "assets/key-solid-full.svg" : ""
                                sourceSize.width: 14
                                sourceSize.height: 14
                                visible: false
                                opacity: 1
                            ...
                            ColorOverlay {
                                anchors.fill: indexesTabIcon
                                source: indexesTabIcon
                                visible: model.type === "indexes"
                                color: "#FFFFFF"
                                opacity: 0.7
                            }
